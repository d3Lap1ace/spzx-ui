        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="single"
                    @click="handleUpdate"
                    v-hasPermi="['user:orderItem:edit']"
                    >修改</el-button
                >
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    :disabled="multiple"
                    @click="handleDelete"
                    v-hasPermi="['user:orderItem:remove']"
                    >删除</el-button
                >
            </el-col>
            <el-col :span="1.5">
                <el-button
                    ...
                    icon="Download"
                    @click="handleExport"
                    v-hasPermi="['user:orderItem:export']"
                    >导出</el-button
                >
            </el-col>
            <right-toolbar
...
function handleDelete(row) {
    ...
    proxy.$modal
        .confirm('是否确认删除订单项信息编号为"' + _ids + '"的数据项？')
        .then(function () {
